...
<!-- Button (blue), duh! -->
	<button class="rounded-lg absolute top-0 right-0  bg-white hover:text-blue-500 focus:outline-none focus:shadow-outline text-gray-500 font-semibold py-2 px-4 mr-56  " @click="open = true"  >Solicitar reavaliação</button>
		...
		<div
			...
			<div class="modal-content2 py-4 text-left px-6">
				...
				<div class="flex justify-between items-center pb-3">
					<p class="text-2xl font-bold text-gray-600">Reavaliação</p>
				...
				<form id="form1" name="form1" method="post" action="reavaliacao.php">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
							...
							<div class="w-full md:w-1/2 px-3">
							    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="datasoli" id="datasoli"  placeholder ="Data de Solicitação" /><br>
							</div>
							<div class="w-full md:w-full px-4 mb-6">
