			...
			<div
				...
				<div class="modal2-content py-4 text-left px-8">
					...
					<div class="flex justify-between items-center pb-3">
						<p class="text-2xl font-bold appearance-none block w-full  text-gray-700 py-2 px-2 mb-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">Informe os dados da requisicão e a matricula do atendente</p>
					...
					<form method="POST" id="meuForm" class="bg-white shadow-md rounded w-full px-10 pt-6 pb-8 mb-4">
						...
						<input type="text"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-2 mb-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="matricula" placeholder="Matricula" id="matricula" ><br>
