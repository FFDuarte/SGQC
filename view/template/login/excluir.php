...
<!-- Button (blue), duh! -->
	...
	<button class="rounded-lg absolute top-0 right-0  bg-white hover:text-blue-500 focus:outline-none focus:shadow-outline text-gray-500 font-semibold py-2 px-4 mr-32 md:px-4  " @click="open = true"  >Excluir</button>
		...
		<div class="absolute top-0 left-0 flex items-center justify-center w-full h-full"  x-show="open"  >
			...
			<div
				...
				<div class="modal2-content py-4 text-left px-8">
					...
					<form id="form1" name="form1" method="post" action="excluirlogin.php">
						<Label class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-2 mb-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"> Insira  o login deseja excluir. </label>
