			...
			<div
				...
				<div class="modal2-content py-4 text-left px-8">
					...
					<div class="flex justify-between items-center pb-3">
						<p class="text-2xl font-bold text-gray-600">Excluir Veiculo</p>
				    ...
				    <form id="form1" name="form1" method="post" action="excluirVeiculos.php">
						<Label class="appearance-none block w-full rounded py-2 px-2 mb-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"> Insira a placa do veiculo </label>
