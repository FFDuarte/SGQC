...
$(document).ready(function(){
				jQuery('#meuForm').submit(function(){
						...
						$.ajax({
							...
							url: '../template/programacao/cadastro.php',
							cache: false,
							data: dados,
							type: "POST",
		...
		<div class="border border-teal-500 shadow-lg modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
			<div class="modal-content py-4 text-left px-6">
				...
				<div class="flex justify-between items-center pb-3">
					<p class="text-2xl font-bold">Registrar Programação</p>
				...
				<section id="segura-items">
					<form method="POST" id="meuForm" class="bg-white shadow-md rounded w-full px-10 pt-6 pb-8 mb-4">
					    ...
					    <div class="flex flex-wrap -mx-3 mb-6">
							...
							<div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
							    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="dataprog" id="dataprog" placeholder="Data" /><br>
							</div>
							<div class="w-full md:w-1/2 px-3">
							...
							<div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
							    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="prevretorno" id="prevretorno" placeholder="Prev de Retorno" /><br>
							</div>
