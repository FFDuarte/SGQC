...
$(document).ready(function(){
				jQuery('#meuForm').submit(function(){
						...
						$.ajax({
							...
							url: '../template/decreto/veiculo/cadastro.php',
							cache: false,
							data: dados,
							type: "POST",
...
<style>
	...
	<div>
		<button onclick="openModal()" class='rounded-lg absolute top-0 right-0  bg-white hover:text-blue-500 focus:outline-none focus:shadow-outline text-gray-500 font-semibold py-2 px-2 md:px-4'>Inserir decreto </button>
	</div>
		...
		<div class="border border-teal-500 shadow-lg modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
			<div class="modal-content py-4 text-left px-6">
				...
				<div class="flex justify-between items-center pb-3">
					<p class="text-2xl font-bold">Inserir decreto do veiculo</p>
				...
				<section id="segura-items">
					<form method="POST" id="meuForm" class="bg-white shadow-md rounded w-full px-10 pt-6 pb-8 mb-4">
					    ...
					    <div class="flex flex-wrap -mx-3 mb-6">
							...
							<label class="appearance-none block text-gray-700  rounded py-1 px-2 leading-tight 0">Placa </label>
							...
							<label class="appearance-none text-gray-600  rounded py-1 px-2 leading-tight 0">Inciso </label>
							...
							<div class="w-full md:w-1/2 px-3">
							<label class="appearance-none text-gray-600  rounded py-1 px-2 leading-tight 0">Data </label>
							...
							<div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
						       <label class="appearance-nonetext-gray-600  rounded py-1 px-2 leading-tight 0">Portaria </label>
							...
							<div class="w-full md:w-1/2 px-3">
							  ...
							  <label class="appearance-none block   text-gray-600  rounded py-1 px-2 leading-tight 0">Descrição </label>
							     ...
							     <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="descricao" id="descricao" placeholder="descricao" /><br>
							</div>
						</div>
