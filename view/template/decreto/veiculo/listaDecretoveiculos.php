...
<script type="text/javascript">
    ...
    load_dados(null, 'pesquisadescretoVeiculo.php', '#MostraPesq');
    ...
    $('#pesquisaCliente').keyup(function(){
        ...
        {
            load_dados(valores, 'pesquisadescretoVeiculo.php', '#MostraPesq');
        }else
        {
            load_dados(null, 'pesquisadescretoVeiculo.php', '#MostraPesq');
        }
                    ...
                    <form name="form_pesquisa" id="form_pesquisa" method="post" action="">
                            <fieldset>
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input class=" text-Black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="text" name="pesquisaCliente" id="pesquisaCliente" value="" tabindex="1" placeholder="Pesquisar cliente..." />
									</div>
