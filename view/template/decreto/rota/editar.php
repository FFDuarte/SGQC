		...
		<div
			...
			<div class="modal-content2 py-4 text-left px-6">
				...
				<div class="flex justify-between items-center pb-3">
					<p class="text-2xl font-bold text-gray-600">Insira o registro e os dados para edição</p>
				...
				<form id="form1" name="form1" method="post" action="editar/editarDecretorotas.php">
