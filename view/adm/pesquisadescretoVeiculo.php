...
<?php
	...
	$msg .="	<thead>";
	$msg .="		<tr>";
	$msg .="			<th class='bg-gray-500 border-r-2 border-gray-600  py-2 text-gray-900 font-bold tracking-wider uppercase text-xs'>placa</th>";
	...
	$msg .="	<tbody>";
                ...
                //requerimos a classe de conexão
					...
					try {
					    ...
					    $resultado = $conn->query("SELECT * FROM decretos,veiculo where rotas_id_Rotas = idVec and rotas_id_Rotas >=1 and placa  LIKE '$parametro%' " );
