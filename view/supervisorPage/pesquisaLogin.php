...
<?php
	...
	$msg .="			<th class='bg-gray-500  py-2 text-gray-900 font-bold tracking-wider uppercase text-xs'>Status:</th>";
	...
	$msg .="	<tbody>";
                ...
                //requerimos a classe de conexão
					...
					try {
					    ...
					    $resultado = $conn->query("SELECT * FROM funcionario,login where idFuncionario = Funcionario_idFuncionario and matricula  LIKE '$parametro%' " );
    ...
    $msg .="					<td class='bg-gray-200  px-6 py-2 text-gray-600 font-bold tracking-wider uppercase text-xs'></td>";
